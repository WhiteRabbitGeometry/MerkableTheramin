...
## v2.1.6 — Geometry reference metronomes
- Reference coordinates display as 0–100 integers; normalized decimals remain internal.
- Factory reference metronomes:
  - Wild: A 43,35 · B 59,30
  - Bells: A 36,36 · B 52,22
  - Ding: A 36,35 · B 53,26
- Reference metronomes can be recalled, armed, renamed, deleted, exported as `.met`, and imported from `.met`.
- Axis Tilt adds a relative plane/orientation control for the two geometry shells.
- Armed-reference pitch varies with alignment: closer/straighter alignment rises in register; weaker/oblique alignment falls.
- Reference Metronome mute remains a separate channel from Auto-Sonify Geometry.
